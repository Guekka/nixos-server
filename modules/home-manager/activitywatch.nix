# from <https://github.com/foo-dogsquared/nixos-config/blob/master/modules/home-manager/services/activitywatch.nix>
{
  config,
  lib,
  pkgs,
  ...
  generateWatchersConfig = name: cfg: let
...
in {
  ...
  config = lib.mkIf cfg.enable {
    ...
    systemd.user.services =
      lib.mapAttrs' mkWatcherService cfg.watchers
      // {
        activitywatch = {
          Unit = {
